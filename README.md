...
- Planning of this project was done using Github Kanban for agile methodolodies which can be found [here] (https://github.com/users/ubachicodes/projects/3) also my Issues/Milestones are documented [here] (https://github.com/ubachicodes/restaurant/issues).
